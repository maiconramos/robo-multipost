...
import { RequireProfileMembershipGuard } from '@gitroom/backend/services/auth/profile/require-profile-member.guard';
...
import { ProfileSeedModule } from '@gitroom/nestjs-libraries/database/prisma/profiles/profile.seed.module';
...
@Module({
  ...
  providers: [
    ...
    {
      provide: APP_GUARD,
      useClass: RequireProfileMembershipGuard,
    },
  ],
  exports: [
    DatabaseModule,
