        ...
        <section className="flex flex-col gap-[10px]">
          ...
          <div className="rounded-[8px] border border-fifth bg-sixth overflow-hidden">
            ...
            {postsByChannel.map((p, i) => (
              ...
              >
                <ChannelAvatar
                  picture={p.channel?.picture ?? null}
                  name={p.channel?.name ?? ''}
                  identifier={p.channel?.identifier}
                />
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-[12px] mt-[3px]">
                    <DebugLink href={`/p/${p.latestId}`}>
                      {t('status_view_post', 'Ver post')} ↗
                    </DebugLink>
                    {temporalPostUrl(p.latestId) && (
                      <DebugLink href={temporalPostUrl(p.latestId)!}>
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-[12px] mt-[3px]">
                    ...
                    <DebugLink href={`/automacoes/${a.flowId}`}>
