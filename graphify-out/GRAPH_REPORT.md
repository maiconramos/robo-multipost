# Graph Report - robo-multipost  (2026-05-14)

## Corpus Check
- 881 files · ~783,807 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7698 nodes · 14359 edges · 835 communities (372 shown, 463 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 319 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `82b3b792`
...
1. `useT()` - 461 edges
2. `useFetch()` - 307 edges
3. `useToaster()` - 142 edges
4. `makeId()` - 130 edges
...
## Communities (835 total, 463 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.03
Nodes (80): GlobalError(), LoginWithOidc(), metadata, Inputs, Register(), RegisterAfter(), WalletProvider, useReturnUrl() (+72 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (81): DatePicker(), isUSCitizen(), ExistingDataContext, useExistingData(), CalendarIcon(), CheckmarkIcon(), ChevronDownIcon(), ChevronUpIcon() (+73 more)

### Community 2 - "Community 2"
Cohesion: 0.04
Nodes (28): AuthMiddleware, removeAuth(), AuthService, decrypt_legacy_using_IV(), deriveLegacyKeyIv(), encrypt_legacy_using_IV(), { keyLength, ivLength }, CreateOrgUserDto (+20 more)

### Community 3 - "Community 3"
Cohesion: 0.05
Nodes (39): CaptionDto, ASPECT_RATIOS, GenerateVideoBodyDto, MODES, authenticatedController, CreateGeneratedPostsDto, InnerPost, PostGroup (+31 more)

### Community 4 - "Community 4"
Cohesion: 0.05
Nodes (66): ApprovedAppsComponent(), useApprovedApps(), AddOrEditWebhook(), Autopost(), details, getOptions(), getOptionsChoose(), getPostImmediately() (+58 more)

### Community 5 - "Community 5"
Cohesion: 0.05
Nodes (63): AppliedCouponDisplay(), CouponInput(), FormWrapper(), PriceBreakdown(), StripeInputs(), SubmitBar(), Total(), FirstStep() (+55 more)
...
Cohesion: 0.04
Nodes (46): metadata, Activate(), ResendInputs, ResendStatus, Forgot(), Inputs, ForgotReturn(), Inputs (+38 more)
...
Cohesion: 0.04
Nodes (21): IntegrationTimeDto, IntegrationValidateTimeDto, FieldsDto, PlugDto, CreateTagDto, GetPostsListDto, PrismaRepository, PrismaService (+13 more)
...
Cohesion: 0.05
Nodes (21): CREDENTIAL_ALIAS, ENV_MAPPING, facebookCreds, linkedinCreds, DiscordProvider, GenerateAuthUrlResponse, usageCache, ZernioBaseProvider (+13 more)
...
Cohesion: 0.05
Nodes (44): AnalyticsComponent(), StarsAndForks(), StarsTableComponent(), getPlatformIconPath(), useZernioAccounts(), ZernioAccount, ZernioAccountsResponse, useZernioProfiles() (+36 more)

### Community 18 - "Community 18"
Cohesion: 0.11
Nodes (32): DevtoTags(), SelectOrganization(), DiscordChannelSelect(), DiscordComponent(), DribbbleTeams(), Select, HashnodePublications(), HashnodeTags() (+24 more)

### Community 19 - "Community 19"
Cohesion: 0.06
Nodes (46): SignatureBox(), CopyButton(), DeveloperComponent(), useOAuthApp(), DeveloperIconComponent(), MantineWrapper(), usePreventWindowUnload(), PlusIcon() (+38 more)

### Community 20 - "Community 20"
Cohesion: 0.05
Nodes (37): DevtoSettings(), DribbbleSettings(), isMp4, url, Canonical(), ColorPicker(), Input(), HashnodeSettings() (+29 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (37): ModeTab(), ModeTabProps, ReferenceImageDropzone(), ReferenceImageDropzoneProps, textToTiptapHtml(), VideoFrame(), AiCaption(), AiImage() (+29 more)
...
Cohesion: 0.07
Nodes (28): ThreadFinisher(), Checkbox, IntegrationContext, delayOptions, InternalChannels(), PlugField(), LinkedinPreview(), LinkedInSettings() (+20 more)
...
Cohesion: 0.12
Nodes (25): FacebookPreview(), FacebookSettings(), useIntegration(), useMediaDirectory(), VideoOrImage(), ChevronLeftIcon(), ChevronRightIcon(), graduationStrategies (+17 more)
...
Cohesion: 0.06
Nodes (27): callToActionTypes, GmbSettings(), topicTypes, LemmySettings(), MoltbookSettings(), allProviders(), AllProvidersSettings, EmptySettings (+19 more)
...
Cohesion: 0.09
Nodes (10): ChatModule, AgentState, LoadToolsService, MastraService, isKnowledgeBaseEnabled, pStore, KnowledgeRepository, ALLOWED_MIME_TYPES (+2 more)
...
Cohesion: 0.09
Nodes (4): CreateOAuthAppDto, OAuthService, UpdateOAuthAppDto, OAuthAppController
...
Cohesion: 0.12
Nodes (8): AuthProvider(), AuthProviderParams, client, FarcasterProvider, clientAndYoutube(), GoogleProvider, hexToUint8Array(), WalletProvider
...
Cohesion: 0.16
Nodes (13): Textarea(), Voice, Voices, VoiceSelector(), VEO3Settings(), Voice, useVideo(), VideoContextWrapper (+5 more)

### Community 94 - "Community 94"
Cohesion: 0.37
Nodes (7): AgentToolInterface, getAuth(), checkAuth(), socialIntegrationList, EMPTY_CONTEXT, MinimalRequestContext, readRequestContext()
...
Cohesion: 0.29
Nodes (3): ToolReturn, getValidationSchemas(), GenerateVideoOptionsTool
...
- **Why does `useT()` connect `Community 5` to `Community 0`, `Community 1`, `Community 4`, `Community 7`, `Community 10`, `Community 15`, `Community 16`, `Community 17`, `Community 18`, `Community 19`, `Community 20`, `Community 21`, `Community 23`, `Community 33`, `Community 34`, `Community 161`, `Community 37`, `Community 40`, `Community 51`, `Community 190`, `Community 86`, `Community 91`, `Community 93`?**
  _High betweenness centrality (0.060) - this node is a cross-community bridge._
- **Why does `makeId()` connect `Community 6` to `Community 1`, `Community 2`, `Community 7`, `Community 9`, `Community 12`, `Community 13`, `Community 142`, `Community 144`, `Community 145`, `Community 146`, `Community 19`, `Community 21`, `Community 22`, `Community 151`, `Community 152`, `Community 160`, `Community 36`, `Community 42`, `Community 43`, `Community 45`, `Community 175`, `Community 176`, `Community 177`, `Community 178`, `Community 303`, `Community 50`, `Community 53`, `Community 54`, `Community 55`, `Community 187`, `Community 188`, `Community 189`, `Community 69`, `Community 76`, `Community 77`, `Community 205`, `Community 207`, `Community 208`, `Community 206`, `Community 210`, `Community 83`, `Community 211`, `Community 85`, `Community 212`, `Community 209`, `Community 91`, `Community 220`, `Community 221`, `Community 94`, `Community 222`, `Community 223`, `Community 110`, `Community 112`, `Community 242`, `Community 243`, `Community 244`?**
  _High betweenness centrality (0.057) - this node is a cross-community bridge._
- **Why does `useFetch()` connect `Community 17` to `Community 0`, `Community 1`, `Community 34`, `Community 4`, `Community 5`, `Community 7`, `Community 40`, `Community 10`, `Community 15`, `Community 16`, `Community 18`, `Community 19`, `Community 21`, `Community 86`, `Community 23`, `Community 153`, `Community 91`, `Community 93`?**
