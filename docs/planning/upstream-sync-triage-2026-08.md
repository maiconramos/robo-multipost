...
| WordPress | `3c7a6863`, `daffe5b4`, `d027d6f7` | Fix de conexão implementado separadamente em `codex/upstream-wordpress-connect`, preservando SSRF e adicionando diagnóstico seguro. Termos/status permanecem em uma segunda PR. `cc54137d` foi removido da cadeia por alterar apenas TikTok. Ver [`wordpress-connect-upstream-audit-2026-09.md`](./wordpress-connect-upstream-audit-2026-09.md). |
| Auth por e-mail | `dbb48601` | Adotar com specs de repositório: login/reset devem ser case-insensitive sem enfraquecer o email-lock dos convites do fork. |
| DTO estrito | `c3de376f`, `40324535` | Revisar impacto antes de portar; remove conversão implícita e pode revelar clientes que enviam tipos errados. É desejável, mas potencialmente breaking. |
...
| Links em conteúdo | `1f123f17` | Pequeno porte manual no helper já compartilhado; adicionar casos com pontuação, múltiplos links e Unicode. |
